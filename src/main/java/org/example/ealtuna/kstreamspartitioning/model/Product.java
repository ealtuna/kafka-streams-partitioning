...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4280553172902558958L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"org.example.ealtuna.kstreamspartitioning.model\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public Product(java.lang.CharSequence id, java.lang.CharSequence name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static org.example.ealtuna.kstreamspartitioning.model.Product.Builder newBuilder() {
    return new org.example.ealtuna.kstreamspartitioning.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.example.ealtuna.kstreamspartitioning.model.Product.Builder newBuilder(org.example.ealtuna.kstreamspartitioning.model.Product.Builder other) {
    if (other == null) {
      return new org.example.ealtuna.kstreamspartitioning.model.Product.Builder();
    } else {
      return new org.example.ealtuna.kstreamspartitioning.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.example.ealtuna.kstreamspartitioning.model.Product.Builder newBuilder(org.example.ealtuna.kstreamspartitioning.model.Product other) {
    if (other == null) {
      return new org.example.ealtuna.kstreamspartitioning.model.Product.Builder();
    } else {
      return new org.example.ealtuna.kstreamspartitioning.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.ealtuna.kstreamspartitioning.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.ealtuna.kstreamspartitioning.model.Product other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.Product.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.Product.Builder clearName() {
      name = null;
