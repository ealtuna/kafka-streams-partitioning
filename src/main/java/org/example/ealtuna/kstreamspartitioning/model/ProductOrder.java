...
public class ProductOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9163267638069092349L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductOrder\",\"namespace\":\"org.example.ealtuna.kstreamspartitioning.model\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"productId\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"int\"},{\"name\":\"productName\",\"type\":\"string\"}]}");
   ...
   */
  public ProductOrder(java.lang.CharSequence id, java.lang.CharSequence productId, java.lang.Integer amount, java.lang.CharSequence productName) {
    this.id = id;
   ...
   */
  public static org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder newBuilder() {
    return new org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder();
  }
   ...
   * @return A new ProductOrder RecordBuilder
   */
  public static org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder newBuilder(org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder other) {
    if (other == null) {
      return new org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder();
    } else {
      return new org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder(other);
    }
  }
   ...
   * @return A new ProductOrder RecordBuilder
   */
  public static org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder newBuilder(org.example.ealtuna.kstreamspartitioning.model.ProductOrder other) {
    if (other == null) {
      return new org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder();
    } else {
      return new org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.ealtuna.kstreamspartitioning.model.ProductOrder other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder setAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder setProductName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.ealtuna.kstreamspartitioning.model.ProductOrder.Builder clearProductName() {
      productName = null;
